//! Working Terminal Example
//!
//! A minimal but functional terminal emulator using crt-core + glyphon.
...
impl App {
    ...
    fn update_text_buffer(&mut self) {
        ...
        // Update the glyphon buffer with terminal content
...
impl ApplicationHandler for App {
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        ...
        let width = (COLS as f32 * FONT_SIZE * 0.6) as u32 + 40; // Approximate char width
        ...
        text_buffer.set_size(&mut font_system, Some(size.width as f32 - 40.0), Some(size.height as f32 - 40.0));
        ...
        log::info!("Terminal initialized: {}x{}", COLS, ROWS);
    }
                    ...
                    gpu.text_renderer
                        .prepare(
                            ...
                            [TextArea {
                                ...
                                default_color: Color::rgb(200, 200, 200), // Light gray text
                                custom_glyphs: &[],
                            }],
                            &mut gpu.swash_cache,
                        )
